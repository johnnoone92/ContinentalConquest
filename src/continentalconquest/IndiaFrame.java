 ...
 * @author x13532883
 */
public class IndiaFrame extends javax.swing.JFrame {
String question;
int count;
int count2;
private static final String VOICENAME = "kevin16";
    ...
    try {
            ...
            String find = "select quest,answer,wrongAns,wrongAns2,wrongAns3,q_sel,score from Question where country = 'india' and q_sel = 'N' order by rand() limit 1;";
    ...
    private void initComponents() {
        ...
        Scorelbl.setBounds(0, 540, 410, 20);
        ...
        questionlbl.setBounds(30, 90, 370, 220);

        bgimage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/continentalconquest/indiaflag.jpg"))); // NOI18N
    ...
    try {
        ...
        Logger.getLogger(IndiaFrame.class.getName()).log(Level.SEVERE, null, ex);
    }
    ...
    private void answer2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_answer2ActionPerformed
        // TODO add your handling code here:
         if(count2==4){
                    ...
                    if(count<4){
                        ...
                        Japanlbl.setText("India conquered");
                        questionlbl.setText("");
        ...
        try {
            ...
            Connection conn = DriverManager.getConnection(connectionUrl);
            Statement st = (Statement) conn.createStatement();
            String find = "select quest,answer,wrongAns,wrongAns2,wrongAns3,q_sel from Question where country = 'india' and q_sel = 'N' order by rand() limit 1;";
            ResultSet rs = st.executeQuery(find);
    ...
    private void yBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_yBtnActionPerformed
        ...
        try {
            ...
            try {
                ...
                yBtn.setVisible(false);
                nBtn.setVisible(false);
                String find = "select quest,answer,wronganswer,wronganswer2,wronganswer3,q_sel from Question where country = 'india' and q_sel = 'N' order by rand() limit 1;";
                ResultSet rs = st.executeQuery(find);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IndiaFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IndiaFrame().setVisible(true);
            }
        });
    }
