 ...
 * @author x13332576
 */
public class NewzGUI extends javax.swing.JFrame {
    String insert;
    String question;
    int count;
    int count2;
    ...
    public NewzGUI() {
        ...
        try {
            ...
            String find = "select quest,answer,wrongAns,wrongAns2,wrongAns3,q_sel,score from Question where country = 'newz' and q_sel = 'N' order by rand() limit 1;";
    ...
    private void initComponents() {
        ...
        BGlbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/continentalconquest/NEWZBG.jpg"))); // NOI18N
...
if(count2==10){
                    ...
                    if(count<10){
                        ...
                        TitleLbl.setText("New Zealand conquered");
                        Questionlbl.setText("");
            ...
            while(rs.next()){
                ...
                */
                ...
                if(arr[0].equals(rs.getString("answer"))){
                    ...
                    st3.executeUpdate("update Score set score = 1 where quest = '"+rs.getString("quest")+"'");
                    Scorelbl.setText(rs.getString("score"));
                }
...
if(count2==10){
            ...
            while(rs.next()){
                ...
                */
                ...
                if(Ans2.getText().equals(rs.getString("answer"))){
                    Statement st3 = (Statement) conn.createStatement();
                    st3.executeUpdate("update Question set score = 1 where quest = '"+rs.getString("quest")+"'");

                    String selScore = "select sum(score) from question;";

                    ResultSet rs2 = st3.executeQuery(selScore);

                    Scorelbl.setText(selScore);
                }
            }
    ...
    private void yBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_yBtnActionPerformed
        ...
        try {
            ...
            try {
                ...
                yBtn.setVisible(false);
                nBtn.setVisible(false);
                String find = "select quest,answer,wrongAns,wrongAns2,wrongAns3,q_sel from Question where country = 'newz' and q_sel = 'N' order by rand() limit 1;";
                ResultSet rs = st.executeQuery(find);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewzGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
