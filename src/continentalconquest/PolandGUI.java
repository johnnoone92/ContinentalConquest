 ...
 * @author x13564737
 */
public class PolandGUI extends javax.swing.JFrame {
    //String insert;
    String question;
    int count;
    int count2;
    ...
    public PolandGUI() {
     ...
     try {
            ...
            String find = "select quest,answer,wrongAns,wrongAns2,wrongAns3,q_sel from Question where country = 'poland' and q_sel = 'N' order by rand() limit 1;";     
    ...
    private void initComponents() {
        ...
        questionLbl.setBounds(80, 170, 510, 40);

        polandLbl.setFont(new java.awt.Font("Old English Text MT", 0, 36)); // NOI18N
        polandLbl.setText("Poland Quiz");
        getContentPane().add(polandLbl);
        polandLbl.setBounds(190, 80, 230, 40);
        ...
        flagLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/continentalconquest/polandflag.jpg"))); // NOI18N
    ...
    private void backBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backBtnActionPerformed
        ...
        try {
            ...
            Logger.getLogger(PolandGUI.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        // TODO add your handling code here:
                 if(count2==4){
                    ...
                    if(count<4){
                        ...
                        polandLbl.setText("Poland conquered");
                        questionLbl.setText("");
...
System.out.println("AGGHHHH!!!!!"); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PolandGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
