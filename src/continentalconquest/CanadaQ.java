 ...
 * @author x13508623
 */
public class CanadaQ extends javax.swing.JFrame {
    String question;
    int count;
    int count2;
  ...
  try {
            ...
            String find = "select quest,answer,wrongAns,wrongAns2,wrongAns3,q_sel from Question where country = 'canada' and q_sel = 'N' order by rand() limit 1;";
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(616, 527));
        setPreferredSize(new java.awt.Dimension(640, 520));
        getContentPane().setLayout(null);

        QPnl.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        QPnlLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, QPnlLayout.createSequentialGroup()
                .addComponent(QLbl, javax.swing.GroupLayout.DEFAULT_SIZE, 438, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        getContentPane().add(QPnl);
        QPnl.setBounds(80, 50, 450, 150);
        ...
        AnsBtn1.setBounds(80, 240, 190, 60);
        ...
        AnsBtn2.setBounds(340, 240, 190, 60);
        ...
        AnsBtn3.setBounds(80, 320, 190, 60);
        ...
        AnsBtn4.setBounds(340, 320, 190, 60);
        ...
        BackBtn.setBounds(270, 470, 73, 23);

        ImgLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/continentalconquest/CanadaFlag.png"))); // NOI18N
        getContentPane().add(ImgLbl);
        ImgLbl.setBounds(0, 0, 620, 530);
...
try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CanadaQ.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
