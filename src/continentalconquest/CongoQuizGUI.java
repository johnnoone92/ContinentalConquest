 ...
 * @author x13360866
 */
public class CongoQuizGUI extends javax.swing.JFrame {
         String question;
        int count;
        int count2;
        private static final String VOICENAME = "kevin16";
    /**
     * Creates new form CongoQuizGUI
     */
    public CongoQuizGUI() {
        initComponents();
        question ="";
   ...
   try {
            ...
            String find = "select quest,answer,wrongAns,wrongAns2,wrongAns3,q_sel from Question where country = 'congo' and q_sel = 'N' order by rand() limit 1;";
    ...
    private void initComponents() {
        ...
        CongoExitQuiz = new javax.swing.JButton();
        Scorelbl = new javax.swing.JLabel();
        CongoFlaglbl = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setMinimumSize(new java.awt.Dimension(620, 540));
        getContentPane().setLayout(null);

        Congolbl.setFont(new java.awt.Font("Old English Text MT", 3, 48)); // NOI18N
        Congolbl.setText("Congo");
        getContentPane().add(Congolbl);
        Congolbl.setBounds(10, 10, 170, 60);
        ...
        Questionlbl.setBounds(20, 200, 480, 30);
        ...
        CongoExitQuiz.setFont(new java.awt.Font("Old English Text MT", 0, 18)); // NOI18N
        CongoExitQuiz.setForeground(new java.awt.Color(0, 0, 255));
        CongoExitQuiz.setText("Retire Quest");
        CongoExitQuiz.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CongoExitQuizActionPerformed(evt);
            }
        });
        getContentPane().add(CongoExitQuiz);
        CongoExitQuiz.setBounds(10, 500, 140, 30);
        ...
        Scorelbl.setBounds(170, 490, 410, 40);

        CongoFlaglbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/continentalconquest/CongoFlag.png"))); // NOI18N
        getContentPane().add(CongoFlaglbl);
        CongoFlaglbl.setBounds(0, 0, 620, 540);
        ...
        // TODO add your handling code here:
                  if(count2==4){
                    ...
                    if(count<10){
                        ...
                        Congolbl.setText("Congo conquered");
                        Questionlbl.setText("");
...
System.out.println("AGGHHHH!!!!!"); 
    ...
    private void CongoExitQuizActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CongoExitQuizActionPerformed
        // TODO add your handling code here:
           AfricaQuizGUI newGUI = new AfricaQuizGUI();
        newGUI.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_CongoExitQuizActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CongoQuizGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CongoQuizGUI().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton CongoExitQuiz;
    private javax.swing.JLabel CongoFlaglbl;
