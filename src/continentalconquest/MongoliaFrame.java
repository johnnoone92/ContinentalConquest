 ...
 * @author x13532883
 */
public class MongoliaFrame extends javax.swing.JFrame {
        String question;
        int count;
        int count2;
        private static final String VOICENAME = "kevin16";
    /**
     * Creates new form MongoliaFrame
     */
    public MongoliaFrame() {
        initComponents();
        question="";
        count=0;
        count2=0;
...
try {
            ...
            String find = "select quest,answer,wrongAns,wrongAns2,wrongAns3,q_sel,score from Question where country = 'mongolia' and q_sel = 'N' order by rand() limit 1;";
    ...
    private void initComponents() {
        ...
        Scorelbl.setBounds(300, 20, 60, 20);

        bgimage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/continentalconquest/ws_Mongolia_flag_1280x800.jpg"))); // NOI18N
        getContentPane().add(bgimage);
        bgimage.setBounds(0, 0, 420, 580);
    ...
    private void jButtonbackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonbackActionPerformed
        ...
        AsiaFrame start=null;
            try {
                ...
                Logger.getLogger(MongoliaFrame.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        // TODO add your handling code here:
              if(count2==10){
                    ...
                    if(count<10){
                        ...
                        Japanlbl.setText("Ireland conquered");
                        questionlbl.setText("");
...
Connection conn = DriverManager.getConnection(connectionUrl);
Statement st = (Statement) conn.createStatement();
String find = "select quest,answer,wrongAns,wrongAns2,wrongAns3,q_sel from Question where country = 'mongolia' and q_sel = 'N' order by rand() limit 1;"; 
ResultSet rs = st.executeQuery(find);
...
System.out.println("AGGHHHH!!!!!"); 
    ...
    private void yBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_yBtnActionPerformed
        ...
        try {
            ...
            /* */
            try {
                Japanlbl.setText("Mongolia Quiz");
                ...
                yBtn.setVisible(false);
                nBtn.setVisible(false);
                String find = "select quest,answer,wronganswer,wronganswer2,wronganswer3,q_sel from Question where country = 'mongolia' and q_sel = 'N' order by rand() limit 1;";
                ResultSet rs = st.executeQuery(find);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MongoliaFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MongoliaFrame().setVisible(true);
            }
        });
    }
