 ...
 * @author x13564737
 */
public class RussiaGUI extends javax.swing.JFrame {
    //String insert;
    String question;
    int count;
    int count2;
   ...
   // jdbcTest t; 
    ...
    try {
            ...
            String find = "select quest,answer,wrongAns,wrongAns2,wrongAns3,q_sel,score from Question where country = 'russia' and q_sel = 'N' order by rand() limit 1;";     
    ...
    private void initComponents() {
        ...
        correctLbl.setBounds(40, 490, 550, 40);
        ...
        questionLbl.setBounds(80, 140, 510, 40);

        russiaLbl.setFont(new java.awt.Font("Old English Text MT", 0, 36)); // NOI18N
        russiaLbl.setText("Russia Quiz");
        getContentPane().add(russiaLbl);
        russiaLbl.setBounds(200, 80, 210, 40);
        ...
        flagLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/continentalconquest/russiaflag.jpg"))); // NOI18N
        flagLbl.setText("jLabel1");
        getContentPane().add(flagLbl);
        flagLbl.setBounds(-2, -6, 640, 550);
    ...
    private void backBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backBtnActionPerformed
        ...
        try {
            ...
            Logger.getLogger(RussiaGUI.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        // TODO add your handling code here:
          if(count2==4){
                    ...
                    if(count<4){
                        ...
                        russiaLbl.setText("Russia conquered");
                        questionLbl.setText("");
...
Connection conn = DriverManager.getConnection(connectionUrl);
Statement st = (Statement) conn.createStatement();
String find = "select quest,answer,wrongAns,wrongAns2,wrongAns3,q_sel from Question where country = 'russia' and q_sel = 'N' order by rand() limit 1;"; 
ResultSet rs = st.executeQuery(find);
...
System.out.println("AGGHHHH!!!!!"); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RussiaGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
