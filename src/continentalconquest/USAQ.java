 ...
 * @author x13508623
 */
public class USAQ extends javax.swing.JFrame {
    String question;
    int count;
    int count2;
...
try {
            ...
            String find = "select quest,answer,wrongAns,wrongAns2,wrongAns3,q_sel from Question where country = 'usa' and q_sel = 'N' order by rand() limit 1;";
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(578, 529));
        ...
        voiceBtn.setBounds(500, 0, 80, 70);
        ...
        QPnlLayout.setHorizontalGroup(
            ...
            .addGroup(QPnlLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(QLbl, javax.swing.GroupLayout.DEFAULT_SIZE, 428, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        AnsBtn1.setBounds(80, 250, 210, 60);
        ...
        AnsBtn3.setBounds(80, 330, 200, 60);
        ...
        AnsBtn2.setBounds(320, 250, 210, 60);
        ...
        AnsBtn4.setBounds(320, 330, 210, 60);
        ...
        BackBtn.setBounds(260, 490, 100, 23);

        ImgLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/continentalconquest/USAFlag.png"))); // NOI18N
    ...
    private void AnsBtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AnsBtn1ActionPerformed
        // TODO add your handling code here:
                    ...
                    if(count<10){
                        ...
                        countryLbl.setText("USA conquered");
                        QLbl.setText("");
...
try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(USAQ.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
