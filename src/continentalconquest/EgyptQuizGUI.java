 ...
 * @author x13360866
 */
public class EgyptQuizGUI extends javax.swing.JFrame {
         String question;
        int count;
        int count2;
        private static final String VOICENAME = "kevin16";
    /**
     * Creates new form EgyptQuizGUI
     */
    public EgyptQuizGUI() {
        initComponents();
        question ="";
        ...
        nBtn.setVisible(false);
         try {
            ...
            String find = "select quest,answer,wrongAns,wrongAns2,wrongAns3,q_sel from Question where country = 'egypt' and q_sel = 'N' order by rand() limit 1;";
    ...
    private void initComponents() {
        ...
        EgyptExitQuiz = new javax.swing.JButton();
        Scorelbl = new javax.swing.JLabel();
        EgyptFlagImage = new javax.swing.JLabel();
        ...
        Questionlbl.setBounds(20, 180, 590, 30);
        ...
        EgyptExitQuiz.setFont(new java.awt.Font("Old English Text MT", 0, 18)); // NOI18N
        EgyptExitQuiz.setForeground(new java.awt.Color(0, 0, 255));
        EgyptExitQuiz.setText("Retire Quest");
        EgyptExitQuiz.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                EgyptExitQuizActionPerformed(evt);
            }
        });
        getContentPane().add(EgyptExitQuiz);
        EgyptExitQuiz.setBounds(10, 500, 140, 30);
        ...
        Scorelbl.setBounds(160, 490, 450, 40);

        EgyptFlagImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/continentalconquest/EgyptFlag.gif"))); // NOI18N
        getContentPane().add(EgyptFlagImage);
        EgyptFlagImage.setBounds(0, 0, 620, 540);
    ...
    private void Ans1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Ans1ActionPerformed
        // TODO add your handling code here:
                    ...
                    if(count<10){
                        ...
                        Algerialbl.setText("Egypt conquered");
                        Questionlbl.setText("");
...
System.out.println("AGGHHHH!!!!!"); 
    ...
    private void EgyptExitQuizActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EgyptExitQuizActionPerformed
        // TODO add your handling code here:
        AfricaQuizGUI newGUI = new AfricaQuizGUI();
        newGUI.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_EgyptExitQuizActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EgyptQuizGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EgyptQuizGUI().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton EgyptExitQuiz;
    private javax.swing.JLabel EgyptFlagImage;
