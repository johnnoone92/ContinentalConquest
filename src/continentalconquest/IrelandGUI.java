...
*/
    ...
    private void initComponents() {
        ...
        ScoreLbl.setBounds(430, 30, 100, 20);
        ...
        getContentPane().add(scoreLbl);
        scoreLbl.setBounds(90, 190, 490, 50);
        ...
        questionLbl.setBounds(10, 170, 600, 40);

        irelandLbl.setFont(new java.awt.Font("Old English Text MT", 0, 36)); // NOI18N
        irelandLbl.setForeground(new java.awt.Color(0, 204, 51));
        irelandLbl.setText("Ireland Quiz");
        getContentPane().add(irelandLbl);
        irelandLbl.setBounds(220, 80, 260, 40);
        ...
        flagLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/continentalconquest/irelandflag.jpg"))); // NOI18N
        flagLbl.setText("jLabel1");
        getContentPane().add(flagLbl);
        flagLbl.setBounds(0, 0, 620, 540);
        ...
        if(count2==10){
                    ...
                    answerBtn4.setVisible(false);
                      try {
                        ...
                        String update = "update Continent set locked = 'No';";
                    ...
                    if(count<10){
                        irelandLbl.setText("Retreat!");
                        questionLbl.setText("");
                        scoreLbl.setText("You got "+count+" questions correct. Don't worry, try again?");
                        yBtn.setVisible(true);
                        nBtn.setVisible(true);
                        JOptionPane.showMessageDialog(null,"The other continents have been unlocked!");
                    }
                    else if(count==10){
                        irelandLbl.setText("Ireland conquered");
                        questionLbl.setText("");
