 ...
 * @author x13564737
 */
public class IcelandGUI extends javax.swing.JFrame {
    String question;
    //String insert;
    int count;
    int count2;
  ...
  try {
    ...
    private void backBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backBtnActionPerformed
        ...
        try {
            ...
            Logger.getLogger(IcelandGUI.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        // TODO add your handling code here:
            if(count2==4){
                    ...
                    if(count<4){
                        ...
                        icelandLbl.setText("Iceland conquered");
                        questionLbl.setText("");
...
System.out.println("AGGHHHH!!!!!"); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IcelandGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IcelandGUI().setVisible(true);
            }
        });
    }
