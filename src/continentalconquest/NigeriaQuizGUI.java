 ...
 * @author x13360866
 */
public class NigeriaQuizGUI extends javax.swing.JFrame {
    ...
    /**
     * Creates new form NigeriaQuizGUI
     */
    public NigeriaQuizGUI() {
        initComponents();
        ...
        try {
            ...
            String find = "select quest,answer,wrongAns,wrongAns2,wrongAns3,q_sel from Question where country = 'nigeria' and q_sel = 'N' order by rand() limit 1;";
    ...
    private void initComponents() {
        ...
        NigeriaExitQuiz = new javax.swing.JButton();
        ...
        NigeriaFlagImage = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setMinimumSize(new java.awt.Dimension(620, 540));
        getContentPane().setLayout(null);

        Nigerialbl.setFont(new java.awt.Font("Old English Text MT", 3, 48)); // NOI18N
        Nigerialbl.setText("Nigeria");
        getContentPane().add(Nigerialbl);
        Nigerialbl.setBounds(10, 10, 210, 80);
        ...
        NigeriaExitQuiz.setFont(new java.awt.Font("Old English Text MT", 0, 18)); // NOI18N
        NigeriaExitQuiz.setForeground(new java.awt.Color(0, 0, 255));
        NigeriaExitQuiz.setText("Retire Quest");
        NigeriaExitQuiz.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                NigeriaExitQuizActionPerformed(evt);
            }
        });
        getContentPane().add(NigeriaExitQuiz);
        NigeriaExitQuiz.setBounds(10, 500, 140, 30);
        ...
        jSeparator1.setBounds(0, 110, 620, 2);

        NigeriaFlagImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/continentalconquest/NigeriaFlag.jpg"))); // NOI18N
        getContentPane().add(NigeriaFlagImage);
        NigeriaFlagImage.setBounds(0, 0, 620, 540);
        ...
        // TODO add your handling code here:
                  if(count2==10){
                    ...
                    if(count<10){
                        ...
                        Nigerialbl.setText("Nigeria conquered");
                        Questionlbl.setText("");
...
System.out.println("AGGHHHH!!!!!"); 
    ...
    private void NigeriaExitQuizActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NigeriaExitQuizActionPerformed
        // TODO add your handling code here:
           AfricaQuizGUI newGUI = new AfricaQuizGUI();
        newGUI.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_NigeriaExitQuizActionPerformed
    ...
    private void yBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_yBtnActionPerformed
        ...
        try {
            ...
            /* */
            try {
                Nigerialbl.setText("Nigeria Quiz");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NigeriaQuizGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NigeriaQuizGUI().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton NigeriaExitQuiz;
    private javax.swing.JLabel NigeriaFlagImage;
